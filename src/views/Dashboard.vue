  ...
  <div class="dashboard-wrapper">
    ...
    <div class="dashboard-item medium">
      ...
      <div v-if="users.length > 0" class="dashboard-item-content">
        <ul class="event-list">
          <li  class="event-list-item" v-bind:key="user.id" v-for="user in users.sort((a, b) => new Date(a.date_of_birth) == new Date(b.date_of_birth) ? 0 : new Date(a.date_of_birth) < new Date(b.date_of_birth)) ? -1 : 1">
